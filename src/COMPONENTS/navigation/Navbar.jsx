...
const Navbar = ({navPresence,setNavPresence,navibarH}) => {
    const GreenNav = useRef(null)
    const location = useLocation().pathname
    const isHome = location === '/'
    const isProject = location === '/projects'
    ...
    return (
        <div>
            <div
            style={{backgroundColor:`${isProject ? 'white' : ''}`}}
             className='fixed top-0 z-100 flex justify-between h-13 w-full'>
                <div className={`w-[18vh] ${navibarH} transition-all p-2 md:p-3`}>
                ...
                <div
                    ...
                    className='homeNav bg-black h-[12vw] md:h-full w-[28vh] md:w-[16vw] relative cursor-pointer transition-opacity duration-2000'
